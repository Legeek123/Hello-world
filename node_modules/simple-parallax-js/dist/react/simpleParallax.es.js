import V, { useState as o, useRef as y, useCallback as H, useEffect as f } from "react";
class d {
  constructor() {
...
const S = d.getInstance(), A = (e) => {
  const [t, n] = o(0), [a, i] = o(!1), r = y(null), s = H(() => {
  ...
  const [s, u] = o(0), [c, w] = o(0), [g, b] = o(""), [p, x] = o(0), h = O();
  return f(() => {
    if (!e)
      return;
    const l = j(t, n);
...
const _ = ({
  ...
  var F;
  const u = t ?? "up", c = n ?? 1.2, w = (F = s == null ? void 0 : s.props) == null ? void 0 : F.src, [g, b] = o(!1), [p, x] = o(0), [h, l] = o(null), [k, C] = o(""), [T, z] = o(""), [I, L, P] = A(w), [M, E] = Y({
    root: null,
    rootMargin: "0px",
